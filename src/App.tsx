...
// //       // Добавляем новый номер в список для отображения с цветом
// //       if (last) {
// //         const colorIndex = called.length % BALL_COLORS.length;
// //         setDisplayNumbers((prev) => [
// //           ...prev,
// //           { number: last, color: BALL_COLORS[colorIndex] },
// //         ]);
...
// //     setDisplayNumbers((prev) => prev.slice(0, -1));
// //     if (db && !offline) {
// //       set(ref(db, "bingoGame"), {
// //         called: newCalled,
...
export default function BingoCaller() {
  ...
  const gridColumnsCount = Math.ceil(numbers.length / GRID_ROWS);
